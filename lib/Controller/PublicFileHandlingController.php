...
class PublicFileHandlingController extends Controller{
    ...
    /**
     * load share excalidraw file by path
     *
     * @NoAdminRequired
     * @PublicPage
     * @NoCSRFRequired
    ...
    public function save($token, $filecontents, $path) {
        ...
        if($file->isUpdateable()) {
            ...
            // Not writeable!
            $this->logger->error('User does not have permission to write to share file: ' . $file->getPath(), ['app' => 'excalidraw']);
